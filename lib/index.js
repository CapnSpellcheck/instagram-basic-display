...
class InstagramBasicDisplayApi {
    ...
    extendLongLivedToken(accessToken) {
        const data = {grant_type: 'ig_refresh_token', access_token: accessToken}
        return axios.get(`${INSTAGRAM_GRAPH_BASE_URL}/refresh_access_token?${querystring.stringify(data)}`)
            .then(res => res.data)
    }
